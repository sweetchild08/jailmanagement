...
namespace eserve2
{
    public partial class frmjail : Form
    {
        ...
        void loadMugshot()
        {
            ...
            helper.db.comm.Parameters.AddWithValue("@cid", ids[comboBox2.SelectedIndex]);
            helper.db.dr = helper.db.comm.ExecuteReader();
            if (helper.db.dr.Read())
            {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            jailreport jr = new jailreport(ids[comboBox2.SelectedIndex]);
            jr.Show();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            adddetainee ad = new adddetainee(ids[comboBox2.SelectedIndex]);
            ad.Show();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                transfer transfer = new transfer(ids[comboBox2.SelectedIndex]);
                transfer.ShowDialog();
                loadSelector();
            }
        }
